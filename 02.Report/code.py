...
if __name__ == "__main__":
    ...
    while(True):
        ...
        payload = "field1=" + str(axisX) + "&field2=" + str(axisY) + "&field3=" + str(axisZ) + "&field4=" + str(
            Rpm) + "&field5=" + str(Speed) + "&field6=" + str(Distance)
        ...
        try:
            ...
            print(" Published axis X =", axisX, " axis Y =", axisY, "axis Z =", axisZ, "Rpm = ", Rpm, "Speed=", Speed,
                  "Distance=", Distance, " to host: ", mqttHost, " clientID= ", clientID,"\n")
